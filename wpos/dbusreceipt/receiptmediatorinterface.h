/***************************************************************************
                          dcopreceiptlinuxbarinterface.h.h  -  description
                             -------------------
 ...
 *                                                                         *
 ***************************************************************************/
#ifndef RECEIPTMEDIATORINTERFACE_H
#define RECEIPTMEDIATORINTERFACE_H
...
class ReceiptMediatorInterface {
     ...
     virtual bool lockRemoteByStartDate(QString, QString)=0;
     virtual bool unlockRemoteByStartDate(QString, QString)=0;
};
