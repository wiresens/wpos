 ...
 * It is used exclusively by XRMethodCall and XRMethodResponse.
 *
 * @see http://www.xmlrpc.com/spec
 * 
 * The clean mapping between QT types is the following.
 * A key feature is that it's REVERSIBLE, i.e. it is one-to-one.
 ...
 *   <li>QT QList<QVariant> : XML-RPC array</li>
...
class XRVariant : public QVariant
{
    ...
    //needed
    QString checkXml(const QString& str);
};
