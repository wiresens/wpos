...
void OfferDeletionWidget::handleOfferListSelected()
{
    ...
    if (cpp == "=")
        operator_label->setText(FIXED);
    else if (cpp == "x")
        operator_label->setText(PERCENT);
    else
        operator_label->clear();
...
void OfferDeletionWidget::deleteOfferType()
{
    ...
    if (QMessageBox::question(this, tr("Delete Offer"), msg, QMessageBox::Yes | QMessageBox::No) == QMessageBox::No)
        return;
