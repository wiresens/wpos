...
void OptionDeletionWidget::delTypeSlot(){
    ...
    if( QMessageBox::question( this, tr("Borrar tipo de opcion"), msg, QMessageBox::Yes | QMessageBox::No) == QMessageBox::No ) return;
...
void OptionDeletionWidget::acceptSlot(){
    ...
    if( QMessageBox::question( this, tr("Borrar opcion"), msg, QMessageBox::Yes | QMessageBox::No) == QMessageBox::No ) return;
