...
struct Colors{
    ...
    static const  QString NUM_KEYBOARD_BUTTON_ON_COLOR;
    static const  QString NUM_KEYBOARD_BUTTON_OFF_COLOR;
    static const  QString NUM_KEYBOARD_BUTTON_SELECTED_COLOR;
